function net = net_init_mnist_dynamic_routing_capsules(opts)
rng('default');
rng(0) ;
input=28*28;
hidden1=256;
...
net.layers{end+1} = struct('type', 'dynamic_routing_linear_capsule','d1',caps_d1,'n1',caps_n1, 'd2',caps_d2,'n2',caps_n2,'B',f*ones(caps_n2,caps_n1), ...
